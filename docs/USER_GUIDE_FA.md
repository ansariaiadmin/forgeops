# راهنمای کامل ForgeOps — DevOps Control Plane — برای افراد غیر فنی
...
- **تکنولوژی:** Next.js 15 + Prisma + SQLite/Postgres
...
http://localhost:3000
```
- ورود: admin@forgeops.dev / Admin@12345 (پس از npm run db:seed)
- سلامت: http://localhost:3000/api/health/live
...
- ایشو باز کن: https://github.com/ansariaiadmin/forgeops/issues
