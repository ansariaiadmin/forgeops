...
echo.
echo ========================================
echo   forgeops — Setup Wizard v3.1.0 — پشتیبانی صفر — تاریکی روشن شد — Windows
echo ========================================
echo.
echo سلام! 👋 جادوگر forgeops — v3.1.0 — تاریکی روشن شد
echo.
...
:create_env
(
echo # forgeops — .env — v3.1.0 — تاریکی روشن شد — %date% %time%
...
echo.
echo 🎉 جادو تمام! forgeops آماده — تاریکی روشن شد! 🎉
